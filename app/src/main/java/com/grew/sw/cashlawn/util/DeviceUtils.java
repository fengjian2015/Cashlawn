...
public class DeviceUtils {
    ...
    private static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) App.get().getSystemService(WIFI_SERVICE);
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) App.get()
    ...
    public static boolean isEmulator() {
        ...
        boolean checkDial = intent.resolveActivity(App.get().getPackageManager()) == null;
...
//        if (checkDebuggerConnected) return true;
    ...
    public static String getUniqueDeviceId(String prefix, boolean useCache) {
        ...
        if (udid == null) {
            synchronized (DeviceUtils.class) {
                if (udid == null) {
                    final String id = SparedUtils.getString(KEY_UDID, null);
                    if (id != null) {
                        udid = id;
                        return udid;
                    }
    ...
    public static boolean isSameDevice(final String uniqueDeviceId) {
        ...
        final String cachedId = SparedUtils.getString(KEY_UDID, null);
    ...
    private static String saveUdid(String prefix, String id) {
        ...
        SparedUtils.putString(KEY_UDID, udid);
        return udid;
    }
